<template>
	<div class="container mx-auto p-4 md:p-6">
		<div class="flex flex-col md:flex-row items-center justify-between mb-6 gap-4">
			<h1 class="text-2xl md:text-3xl font-bold">Player Dashboard</h1>
		...
		<div v-if="stats" class="grid grid-cols-1 gap-4 md:gap-6">
			...
			<div class="bg-white rounded-lg shadow p-4 md:p-6">
				...
				<div class="grid grid-cols-2 gap-4">
					...
					<div class="p-3 bg-gray-50 rounded-lg">
						...
						<div class="text-2xl font-bold">{{ ((stats.gamesWon / stats.totalGames) * 100).toFixed(1) }}%</div>
					</div>
				</div>
			</div>
			...
			<div class="bg-white rounded-lg shadow p-4 md:p-6">
				...
				<div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
					...
					<div class="p-3 bg-gray-50 rounded-lg col-span-2 sm:col-span-1">
						<div class="text-gray-600 text-sm mb-1">Best Leg</div>
			...
			<div class="bg-white rounded-lg shadow p-4 md:p-6">
				...
				<div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
					<div v-for="miss in stats.commonCheckoutMisses" :key="miss.score" 
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
				...
				<div class="bg-white rounded-lg shadow p-4 md:p-6">
					...
					<ul class="space-y-2">
						<li v-for="strength in stats.strengths" :key="strength" 
				...
				<div class="bg-white rounded-lg shadow p-4 md:p-6">
					...
					<ul class="space-y-2">
						<li v-for="weakness in stats.weaknesses" :key="weakness" 
							class="flex items-start">
				...
				<div class="bg-white rounded-lg shadow p-4 md:p-6">
					...
					<ul class="space-y-2">
						<li v-for="tip in stats.trainingTips" :key="tip" 
							class="flex items-start">
		...
		<div v-else class="text-center py-12">
			...
			<NuxtLink to="/games/x01" class="inline-block px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 shadow-sm">
				Start New Game
			</NuxtLink>
		</div>

		<div class="mt-6 flex gap-4">
			<NuxtLink to="/assistant/history/" class="text-blue-600 hover:text-blue-800">View Game History</NuxtLink>
			<NuxtLink to="/games/x01" class="text-blue-600 hover:text-blue-800">Play New Game</NuxtLink>
		</div>
	</div>
</template>
